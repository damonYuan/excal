...
import com.damonyuan.tcal.time.Period;
import com.damonyuan.tcal.time.TimeUnit;
...
public class ActualActual extends DayCounter {
    ...
    public ActualActual(final ActualActual.Convention c) {
        switch (c) {
            ...
            case Euro:
                ...
                break;
            default:
                throw new TcalException("unknown act/act convention");
        }
    }
    ...
    final private class ImplISMA extends DayCounter.Impl {
        ...
        public final double yearFraction(
            ...
            if (refPeriodEnd.le(refPeriodStart) || refPeriodEnd.le(d1)) {
                throw new TcalException("invalid reference period");
            }
            ...
            if (d2.le(refPeriodEnd)) {
                ...
                if (refPeriodStart.gt(d1)) {
                    throw new TcalException("invalid dates");
                }
